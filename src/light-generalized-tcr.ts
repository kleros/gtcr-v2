...
const NO_RULING_CODE = 0;
const REQUESTER_CODE = 1;
const CHALLENGER_CODE = 2;

const ABSENT_CODE = 0;
const REGISTERED_CODE = 1;
const REGISTRATION_REQUESTED_CODE = 2;
const CLEARING_REQUESTED_CODE = 3;
const CHALLENGED_REGISTRATION_REQUEST_CODE = 4;
const CHALLENGED_CLEARING_REQUEST_CODE = 5;
const CONTRACT_STATUS_EXTENDED = new Map<string, number>();
...
const CONTRACT_STATUS_NAMES = new Map<number, string>();
...
function buildNewRound(
  ...
  newRound.appealedAt = BigInt.fromI32(0);
...
export function handleAppealPossible(event: AppealPossible): void {
  ...
  round.appealedAt = BigInt.fromI32(0);
